...
public class WinSaida extends JFrame {
    ...
    public WinSaida() {
        ...
        lblTitulo.setBounds(205, 20, 320, 40);
        panel.add(lblTitulo);
        ...
        btnRemover.addActionListener(e -> {
            if(Integer.parseInt(textQuantidade.getText()) > Integer.parseInt(textEstoqueAtual.getText())){
                JOptionPane.showMessageDialog(this, "A quantidadde a ser removida e " +
        ...
        btnRemover.setBounds(470, 358, 120, 25);
